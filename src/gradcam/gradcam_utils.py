...
def gradcam(model: nn.Module, input_tensor: torch.Tensor, target_layer: str, class_idx: int | None = None) -> ndarray:
    """
...
def gradcam_plus_plus(
    model: nn.Module, input_tensor: torch.Tensor, target_layer: str, class_idx: int | None = None
) -> ndarray:
    """
